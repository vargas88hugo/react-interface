...
const AddAppointment = ({ appointmentId, setAppointmentId, appointments, setAppointments }) => {
  const clearData = {
    ownerName: '',
    petName: '',
    aptDate: '',
  ...
  return (
    <div>
      <button
        className={`${toggleForm ? 'rounded-t-md' : 'rounded-md' } bg-blue-400 text-white px-2 py-3 w-full text-left`}
